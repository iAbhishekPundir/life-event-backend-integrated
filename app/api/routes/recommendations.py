...
def generate_recommendations_by_customer_id(
    customer_id: str,
    ...
    if not life_event.actionable:
        return {
            "status": "No Recommendations Generated",
            "reason": life_event.status,
            "customer": {
                "customer_id": customer_data["customer_id"],
                "name": customer_data["name"],
                "age": customer_data["age"],
            ...
            "recommendations": [],
            "message": "Recommendations are generated only for actionable life events."
        }
